...
example = '{"params":{"shifts":[{"id":46275,"time":[80,84],"jobId":84},{"id":46276,"time":[84,88],"jobId":84},{"id":46277,"time":[113.5,117.5],"jobId":84},{"id":46278,"time":[109.5,113.5],"jobId":84},{"id":46279,"time":[62.5,64.5],"jobId":84},{"id":46280,"time":[60.5,62.5],"jobId":84},{"id":46281,"time":[64.5,66.5],"jobId":84},{"id":46282,"time":[66.5,68.5],"jobId":84},{"id":46283,"time":[68.5,70.5],"jobId":84},{"id":46284,"time":[70.5,72],"jobId":84}],"employees":[{"id":358,"availability":[[59.5,127.5,0],[131.5,152,0],[162.5,168,0]],"maxDayTime":[4,4,4,4,4,4,4],"maxWeekTime":"20","jobIds":[13,14,15,16,17,64,65,83,84]},{"id":152,"availability":[[0,32,0],[35.5,58,0],[61,80,0],[83.5,106,0],[109,128,0],[131.5,168,0]],"maxDayTime":[4,4,4,4,4,4,4],"maxWeekTime":"20","jobIds":[13,14,15,16,17,64,65,83,84]}]}}'
...
def time_in_day(t,d):   # d is day, t is time, returns how much time is in this day.
    d_int = day_to_num(d)
...
for e in range(number_of_employees):
    for d in range(len(days)):
        ...
        for s in range(number_of_shifts):
            if(get_start_day(shifts[s].time) == day_to_num(days[d])):  # TODO : make it work for half a shift of time (the shift may continue to
        ...
        if(True) : print(pulp.LpAffineExpression(nc_int))
