...
class Time:
    ...
    def __init__(self, day_start,start,day_end,end):
        self.start = start + num_of_hours_in_day * day_to_num(day_start)
        self.end = end + num_of_hours_in_day * day_to_num(day_end)
