...
shifts = [
	...
	Shift(1, Time("Mon", 8, 10), 2),   #result - shift1  Ivan Drago				success
	Shift(2, Time("Mon", 12, 20), 3),  #result - shift2  ---					success
	Shift(3, Time("Mon", 0, 24), 5),   #result - shift3  ---					success
	Shift(4, Time("Tue", 8, 10), 2),   #result - shift4  ---					success
	Shift(5, Time("Tue", 11, 20), 3),  #result - shift5  ---					success
	Shift(6, Time("Tue", 0, 24), 3),   #result - shift6  ---					success
	Shift(7, Time("Wed", 8, 10), 2),   #result - shift7  ---					success
	Shift(8, Time("Wed", 12, 20), 3),  #result - shift8  ---					success
	Shift(9, Time("Wed", 20, 22), 1),  #result - shift9  ---					success
	Shift(10, Time("Thu", 12, 20), 1), #result - shift10 ---					success
	Shift(11, Time("Thu", 16, 18), 2), #result - shift11 Ivan Drago				success	
	Shift(12, Time("Thu", 20, 24), 3), #result - shift12 ---					success
]
