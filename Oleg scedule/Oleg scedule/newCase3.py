...
shifts = [
	...
	Shift(1, Time("Mon", 8, 14), 1),   #result - shift1  empty				success
	Shift(2, Time("Mon", 10, 12), 1),  #result - shift2  Inav Drago			success
	Shift(3, Time("Mon", 14, 17), 3),  #result - shift3  empty				success
	Shift(4, Time("Wed", 12, 14), 3),  #result - shift4  Ivan Drago         success
	Shift(5, Time("Wed", 14, 16), 4),  #result - shift5  Ivan Drago			success
	Shift(6, Time("Thu", 12, 16), 5),  #result - shift6  Ivan Drago			success
]
