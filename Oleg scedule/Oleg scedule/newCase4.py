...
# Test case with 3 employee and 6 shifts - only 3 shifts accurated with unique employee - success, but need to use first shifts

shifts = [
	#shift_id - time period from to - job_id         Expected                			Real    
	Shift(1, Time("Sun", 8, 12), 1),   #result - shift1  only one of 3 or empty		   success
	Shift(2, Time("Sun", 8, 12), 1),   #result - shift2  only one of 3 or empty	       success
	Shift(3, Time("Sun", 8, 12), 1),   #result - shift3  only one of 3 or empty        success
	Shift(4, Time("Sun", 8, 12), 1),   #result - shift4  only one of 3 or empty		   success
	Shift(5, Time("Sun", 8, 12), 1),   #result - shift5  only one of 3 or empty	       success
	Shift(6, Time("Sun", 8, 12), 1),   #result - shift6  only one of 3 or empty		   success
]
