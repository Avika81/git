...
shifts = [
	...
	Shift(1, Time("Sun", 8, 14), 1),   #result - shift1  empty						   				success
	Shift(2, Time("Sun", 8, 12), 1),   #result - shift2  only one of 2 not(see below description)	success
	Shift(3, Time("Sun", 8, 12), 1),   #result - shift3  only one of 2 not(see below description)	success
	Shift(4, Time("Mon", 8, 12), 2),   #result - shift4  Ivan Drago									success
	#description not Ivan Drago because he have in sun(8-20) avaible but max day limit is 4
