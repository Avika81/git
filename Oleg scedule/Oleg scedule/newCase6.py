...
shifts = [
	...
	Shift(3, Time("Sun", 14, 16), 1),				#Ivan Drago							success
	Shift(4, Time("Sun", 14, 16), 2),				#Rocky								success
	...
	Shift(13, Time("Wed", 8, 14), 1),				#empty								success
	Shift(14, Time("Wed", 8, 14), 1),				#empty								success
	Shift(15, Time("Wed", 8, 14), 1),				#empty								success
	Shift(16, Time("Wed", 8, 14), 1),				#empty								success
	...
	Shift(21, Time("Fri", 8, 14), 1),				#empty								success
	Shift(22, Time("Fri", 8, 14), 1),				#empty								success
	Shift(23, Time("Fri", 8, 14), 1),				#empty								success
	Shift(24, Time("Fri", 8, 14), 1),				#empty								success
	Shift(25, Time("Sat", 8, 14), 1),				#empty								success
	Shift(26, Time("Sat", 14, 15), 2),				#Rocky								success
	Shift(27, Time("Sat", 16, 18), 1),				#Ivan Drago							success
