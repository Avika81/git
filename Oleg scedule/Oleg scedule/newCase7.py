...
shifts = [
	...
	Shift(1, Time("Sun", 8, 10), 1),     #result -   any unique 1 of 3 employee						success
	Shift(2, Time("Mon", 10, 12), 1),    #result -   any unique 1 of 3 employee						success
	Shift(3, Time("Wed", 12, 14), 1),    #result -   any unique 1 of 3 employee						success
	Shift(4, Time("Fri", 14, 16), 1),    #result -   any unique 1 of 3 employee						success
	Shift(5, Time("Sat", 16, 18), 1),    #result -   any unique 1 of 3 employee						success
