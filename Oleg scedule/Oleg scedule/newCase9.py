...
shifts = [
	...
	Shift(1, Time("Sun", 8, 10), 1),				#Ivan Drago							success
	Shift(2, Time("Sun", 8, 10), 2),				#Rocky								success
	Shift(3, Time("Sun", 14, 18), 1),				#Ivan Drago							success
	Shift(4, Time("Sun", 14, 18), 2),				#Rocky								success
	Shift(5, Time("Mon", 8, 16), 1),				#empty								success
	Shift(6, Time("Mon", 8, 16), 2),				#empty								success
	Shift(7, Time("Mon", 8, 16), 1),				#empty								success
	Shift(8, Time("Mon", 8, 16), 2),				#empty								success
	Shift(9, Time("Tue", 10, 14), 2),               #Rocky or empty						success
	Shift(10, Time("Tue", 10, 14), 2),              #Rocky or empty						success
	Shift(11, Time("Tue", 10, 14), 2),              #Rocky or empty						success
	Shift(12, Time("Tue", 10, 14), 2),              #Rocky or empty						success
	Shift(13, Time("Wed", 8, 14), 1),				#Ivan Drago or empty				success
	Shift(14, Time("Wed", 8, 14), 1),				#Ivan Drago or empty				success
	Shift(15, Time("Wed", 8, 14), 1),				#Ivan Drago or empty				success
	Shift(16, Time("Wed", 8, 14), 1),				#Ivan Drago or empty				success
	Shift(17, Time("Thu", 13, 14), 2),				#Rocky or empty						success
	Shift(18, Time("Thu", 13, 14), 2),				#Rocky or empty						success
	Shift(19, Time("Thu", 13, 14), 2),				#Rocky or empty						success
	Shift(20, Time("Thu", 13, 14), 1),				#Ivan Drago							success
	Shift(21, Time("Fri", 8, 14), 1),				#Ivan Drago or empty				success
	Shift(22, Time("Fri", 8, 14), 1),				#Ivan Drago or empty				success
	Shift(23, Time("Fri", 8, 14), 1),				#Ivan Drago or empty				success
	Shift(24, Time("Fri", 8, 14), 1),				#Ivan Drago or empty				success
	Shift(25, Time("Sat", 8, 14), 1),				#Ivan Drago							success
	Shift(26, Time("Sat", 14, 15), 3),				#Turbo Man							success
	Shift(27, Time("Sat", 16, 18), 3),				#Turbo Man or empty					success
	Shift(28, Time("Sat", 16, 18), 3),				#Turbo Man or empty					success
